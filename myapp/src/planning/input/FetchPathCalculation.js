...
const FetchPathCalculation = async (locationsTypes, attributes, cost, stars, neighborhood, locatedNear) => {
   /* try {
    ...
    const respones = {locations: [{name: "Temple University", address: "1801 N Broad St", lat: 39.9812, lng: -75.1554},{name: "Drexel University", address: "3141 Chestnut St", lat: 39.9566, lng: -75.1899 }, {name: "Philadelphia Academy of Fine Arts", address: "118 N Broad St", lat: 39.9556, lng: -75.1631 }], path: "pathcode"};
    return respones;
